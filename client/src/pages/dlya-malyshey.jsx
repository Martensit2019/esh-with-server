...
const Baby = () => {
  ...
  React.useEffect(() => {
    ...
    dispatch(loadProductsByType('dlya-malyshey', sort, order, currentPage, pageSize))
  ...
  return (
    <div className="category-page">
      <div className="container">
        <div style={{ width: '100%' }}>
          <Breadcrumbs list={['Каталог', 'Для малышей']} />
          <h1>Каталог конструкторов LEGO для малышей</h1>
          <TopFilter />
          {!isProductsLoading ? (
            <>
