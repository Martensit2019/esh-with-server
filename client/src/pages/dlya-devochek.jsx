...
const Girls = () => {
  ...
  React.useEffect(() => {
    ...
    dispatch(loadProductsByType('dlya-devochek', sort, order, currentPage, pageSize))
  ...
  return (
    <div className="category-page">
      <div className="container">
        <div style={{ width: '100%' }}>
          <Breadcrumbs list={['Каталог', 'Для девочек']} />
          <h1>Каталог конструкторов LEGO для девочек</h1>
          <TopFilter />
          {!isProductsLoading ? (
            <>
