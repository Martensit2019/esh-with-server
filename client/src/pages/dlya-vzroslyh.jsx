...
const Mans = () => {
  ...
  React.useEffect(() => {
    ...
    dispatch(loadProductsByType('dlya-vzroslyh', sort, order, currentPage, pageSize))
  ...
  return (
    <div className="category-page">
      <div className="container">
        <div style={{ width: '100%' }}>
          <Breadcrumbs list={['Каталог', 'Для взрослых']} />
          <h1>Каталог конструкторов LEGO для взрослых</h1>
          <TopFilter />
          {!isProductsLoading ? (
            <>
